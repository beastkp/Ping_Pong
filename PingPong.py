...
while True:
    ...
    drawcircle(x, y, 10)
    x, y, playerPosX, changeY, color, playerScore = checkhit(
        x, y, playerPosX, changeY, color, playerScore)
    x, y, changeX, changeY, compScore = moveball(
        x, y, changeX, changeY, compScore)
    drawrect(x, 10, (0, 0, 0))
    if y == 520:
